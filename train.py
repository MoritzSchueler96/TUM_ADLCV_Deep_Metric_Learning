...
def init_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="from_yaml",
        help="Give path to dataset, else path from yaml file will be taken",
    )
    parser.add_argument(
        "--bb_path",
        type=str,
        default="from_yaml",
        help="Give path to bb weight, else path from yaml file will be taken",
    )
    parser.add_argument(
        "--gnn_path",
        type=str,
        default="from_yaml",
        help="Give path to gnn weight, else path from yaml file will be taken",
    )
    parser.add_argument(
        "--net_type",
        type=str,
